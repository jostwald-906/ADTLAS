...
def generate_exec_summary_genai(
    ...
    # Build inventory dict from DF you pass in
    inv_avail = {}
    ...
    try:
        resp = openai.ChatCompletion.create(
            model="gpt-3.5-turbo",  # or gpt-4 / gpt-4o if enabled
            messages=[
        ...
        # Strip potential fences/leading 'json'
        ...
        # Coerce recommendations to list[str]
        ...
        # If model omitted inventory, inject ours
